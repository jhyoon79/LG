...
dir_nbody_pal5 = '/scratch/jhyoon/Research/LG/Nbody_new/pal5/'
dir_nbody = '/scratch/jhyoon/Research/LG/Nbody_new/'
dir_part = '/scratch/jhyoon/Research/LG/Nbody_new/pal5/snapshot/'
;dir_subhalo = '/scratch/jhyoon/Research/LG/nbody_pal5_allsub/nbody_pal5_0.5Myr/snapshot_subhalo/'
...
chr_rdtbl, dir_nbody+'part_peri',0,arr,/silent
arr = double(arr)
t_peri = reform(arr[0,*])
x_peri = reform(arr[1,*])
y_peri = reform(arr[2,*])
...
select_snap = 12
snap_step = 5
t_snap = [0.484,1.490,2.050,3.500,4.100,5.270,5.455,5.620,5.785,7.832,8.620,10.395,11.470,11.640,12.758]
help,t_snap
print,t_snap

;for kk=0,n_elements(t_snap)-1,10 do begin
...
;  snap_end = snap_file+100
;  snap_step = 1
;endif else if (snap_file eq 12758) then begin
...
!p.charsize=1
!p.multi=[0,2,3]
;out_name = dir_nbody_pal5+'tail_VLallsub'
out_name = dir_nbody_pal5+'tail_VLallsub';+string(snap_file,f='(i5.5)')
...
;=== read out data of the tail particles ===
  ...
  if t_part[0] gt 12758 then goto,out
...
;=== read out data of the tail without subhalo ===
  fname_nosub = dir_nosub+'snap'+string(t_part[0],f='(i5.5)')
print,t_part[0],fname_nosub
  chr_rdtbl,fname_nosub,0,arr,/silent
