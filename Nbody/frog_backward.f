...
C***********************************************************************
      ...
      OPEN(UNIT=8,FILE='frogin_backward',STATUS='OLD')
      READ(8,*)nbods
...
C Read in test particle positions and velocities
      OPEN(UNIT=8,FILE='nbody_snap12796',STATUS='OLD')
      DO 10 i=1,nbods
         READ(8,*)tmp,x(i),y(i),z(i),vx(i),vy(i),vz(i)
     +        ,pot_int(i),pot_ext(i),tunbound(i)
 10   CONTINUE
      CLOSE(8)
