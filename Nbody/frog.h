      INTEGER nbods,nmax,nsteps,nout,nout_snap,nsubhalos,nbods_new
     ...
     &       e0_subhalo,maxe_subhalo
      ...
      REAL*8 pot_int,pot_ext,tunbound,pre_tunbound,t_nbody,t_nbody_next
      CHARACTER*52 Nbody_dir
      DATA Nbody_dir/
     + '/scratch/jhyoon/Research/LG/Nbody_new/pal5/ten4_new/'/
C     G = 4.3*10^-6 kpc M_solar^-1 (km/s)^2
     ...
     &                t_peri(0:nmax),pot_peri(0:nmax),J_peri(0:nmax)
      COMMON/nbody/pot_int(0:nmax),pot_ext(0:nmax),pre_tunbound(0:nmax),
     +           t_nbody,t_nbody_next,nbods_new
