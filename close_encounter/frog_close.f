...
C***********************************************************************
      ...
      OPEN(UNIT=8,FILE='frogin_close',STATUS='OLD')
      READ(8,*)nbods
...
C Read in test particle positions and velocities
      OPEN(UNIT=8,FILE='../frog_Pal5_12758.dat',STATUS='OLD')
      DO 10 i=1,nbods
...
c      OPEN(UNIT=9,FILE='frog_subhalo.dat',STATUS='OLD')
      OPEN(UNIT=9,FILE='close_10Rs_e8',STATUS='OLD')
      DO 20 i=1,nsubhalos
...
C***********************************************************************
      ...
      OPEN(UNIT=997,FILE=out_dir//'encounter_10Rs_e8/part_peri')
      DO i=1,nbods
...
C Initial energy --- added by J.H. Yoon
 ...
 5       CONTINUE
      ...
      fname=sstring(1:9)
      OPEN(UNIT=10,FILE=out_dir//'encounter_10Rs_e8/snapshot/'
     &                   //fname,STATUS='UNKNOWN')
...
C Initial energy --- added by J.H. Yoon
 ...
 5       CONTINUE
      ...
      fname=sstring(1:12)
      OPEN(UNIT=10,FILE=out_dir//'encounter_10Rs_e8/snapshot_subhalo/'
     &                  //fname,STATUS='UNKNOWN')
...
C
            ...
            OPEN(UNIT=10+i,FILE=out_dir//'encounter_10Rs_e8/'//fname)
C The particles should conserve their total energy
            maxe(i)=zero
            e0(i)=(vx(i)*vx(i)+vy(i)*vy(i)+vz(i)*vz(i))/2.+pot(i)
