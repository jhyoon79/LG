...
dir_part = '/media/SEADISK/LG/realistic/snapshot/'
...
openw,1,'frog_rotate2xy_5.5Gyr.new'
!p.multi=[0,2,2]
...
plot,x_part,y_part,psym=3,xr=[-20,20],yr=[-20,20],/isotropic,xtit='x',ytit='y'
plot,y_part,z_part,psym=3,xr=[-20,20],yr=[-20,20],/isotropic,xtit='y',ytit='z'
