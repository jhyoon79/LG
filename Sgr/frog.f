...
C Read in test particle positions and velocities
      OPEN(UNIT=8,FILE='frog_sgr.dat',STATUS='OLD')
      DO 10 i=1,nbods
...
c      OPEN(UNIT=9,FILE='frog_subhalo.dat',STATUS='OLD')
      OPEN(UNIT=9,FILE='../frog_BI5subhalo.dat',STATUS='OLD')
      DO 20 i=1,nsubhalos
...
C***********************************************************************
      ...
      OPEN(UNIT=997,FILE='part_peri',STATUS='UNKNOWN')
      DO i=1,nbods
...
C Initial energy --- added by J.H. Yoon
 ...
 5       CONTINUE
      ...
      fname='snapshot_subhalo/'//sstring(1:11)
      OPEN(UNIT=10,FILE=fname,STATUS='UNKNOWN')
...
C***********************************************************************
      SUBROUTINE out
C   print out the position & velocity of the first particle(Sgr center)
C***********************************************************************
      INCLUDE 'frog.h'
      INTEGER i,istring
